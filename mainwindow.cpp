    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->widget_3->hide();
    connect(ui->kaishi,&QPushButton::clicked,
            [=]()
    {
        start(ps);
        ui->widget->hide();
    ...
    connect(ui->tuichu,&QPushButton::clicked,this,&MainWindow::close);
    connect(ui->onedayg,&QPushButton::clicked,
            [=]()
    {
        oneday(ps);
    }
            );
    connect(ui->onemonthg,&QPushButton::clicked,
            [=]()
    {
        for(int i=0;i<30;i++)
            oneday(ps);
    ...
    connect(ui->pigchang,&QPushButton::clicked,
            [=]()
    {
        printallsty(ps);
    }
